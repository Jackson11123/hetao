        ...
        <a-row :gutter="24">
          ...
          <a-col>
            <a-form-item label="是否在提交后显示答案">
              <div class="switch-with-text">
                <a-switch v-model:checked="formData.showAnswerAfterSubmit" />
                <span class="switch-text">{{ formData.showAnswerAfterSubmit ? '是' : '否' }}</span>
              </div>
            </a-form-item>
          </a-col>
        </a-row>
...
- $[10000000]_补$
- $[10000000]_原$`,
  answer: `type: objective # 表明该题为客观题
