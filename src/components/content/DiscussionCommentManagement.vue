<template>
  <div class="discussion-comment-management">
    <div class="page-header"><h2>讨论评论管理</h2></div>
...
const searchForm = reactive({ discussionId: '', commentId: '', keyword: '', reportStatus: '', commentStatus: '', startTime: null as Dayjs | null, endTime: null as Dayjs | null, operatorUid: '', operatorName: '' })
...
const tableData = ref([
  { id: '1', discussionId: '2226925515648', publisherId: '54082419', publisherName: 'OJ小宋', content: '不是，谁给我举报了', relatedProblem: '', category: '', likeCount: 27, commentCount: 41, reportCount: 27, submitTime: '2025-03-02 20:20:58', status: '公开', lastOperator: '' },
])
