...
const tableData = ref([
  { id: '1', problemId: '60087', publisherId: '47981764', publisherName: '途寒', content: '你个***********', likeCount: 0, commentCount: 1, reportCount: 6, submitTime: '2025-08-05 13:09:26', status: '管理删除', statusNote: '已删除', lastOperator: 'ningliang' },
  { id: '2', problemId: '55266', publisherId: '7647861', publisherName: '瓜灯', content: '你是傻逼', likeCount: 0, commentCount: 4, reportCount: 5, submitTime: '2025-06-23 14:37:19', status: '管理删除', statusNote: '已删除', lastOperator: 'ningliang' },
])
const handleSearch = () => { message.info('搜索完成（原型展示）') }
const handleManage = (record: any) => { message.info(`管理题解: ${record.id}（原型展示）`) }
</script>
